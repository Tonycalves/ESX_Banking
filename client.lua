...
local atms = {
  ...
  {name="ATM", id=277, x=-283.075, y=6226.059, z=31.187},
  {name="ATM", id=277, x=-135.165, y=6365.738, z=31.101},
  {name="ATM", id=277, x=-96.999, y=6455.301, z=31.784},
  ...
  {name="ATM", id=277, x=1702.948, y=4933.593, z=42.051},
  ...
  {name="ATM", id=277, x=-1205.044, y=-326.03, z=37.870},
  ...
  {name="ATM", id=277, x=146.6516, y=-1035.43, z=29.344},
  ...
  {name="ATM", id=277, x=-1415.9501, y=-211.976, z=46.500},
  ...
  {name="ATM", id=277, x=-1391.0083, y=-590.312744, z=29.319},
  {name="ATM", id=277, x=-2294.68359, y=356.442932, z=174.6017},
}

-- Banks
local banks = {
  {name="Banque", id=108, x=148.834, y=-1041.858, z=29.374},
  {name="Banque", id=108, x=-1212.980, y=-332.367, z=37.787},
  {name="Banque", id=108, x=-2961.582, y=482.627, z=15.703},
  {name="Banque", id=108, x=-112.202, y=6469.295, z=31.626},
  {name="Banque", id=108, x=313.187, y=-280.621, z=54.170},
  {name="Banque", id=108, x=-351.534, y=-51.529, z=49.042},
  {name="Banque", id=108, x=247.727, y=224.706, z=106.286},
}
...
function IsNearATM()
  ...
  for _, item in pairs(atms) do
    ...
    if(distance <= 2) then --distance de l'atm
      return true
    end
  end
end
...
RegisterNetEvent("banking:HideHUD")
AddEventHandler("banking:HideHUD", function()
  SendNUIMessage({
    hideHUD = true,
  })
end)

RegisterNetEvent("banking:NoHideHUD")
AddEventHandler("banking:NoHideHUD", function()
  SendNUIMessage({
    hideHUD = false,
  })
end)
